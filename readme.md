...
| June 2021 | <ul><li>Added Joi validator for log-in, sign-up and reset-password page</li><li>Created notifications reducer (Frontend) for popupNotify component</li></ul>|
